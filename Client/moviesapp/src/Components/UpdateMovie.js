    ...
    return (
      <div className="App" >    
        ...
        <form className='form' onSubmit={e => customSubmit(e)} >
            ...
            <div className='form-group'>
              Genres: &nbsp; <input type="text" value={movie.Genres} onChange={e => setMovie({...movie, Genres: e.target.value })}/>
            </div>
            <div className='form-group' >
              Yaer Premiered: <input type="text" value={movie.Year_Premiered} onChange={e => setMovie({...movie, Year_Premiered: e.target.value })}/>
            </div>
            <div className='form-group'>
            Image: &nbsp; <input type="text" value={movie.Image} onChange={e => setMovie({...movie, Image: e.target.value })}/>
            </div>
